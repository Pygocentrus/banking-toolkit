...
const formatLine = (line) => {
  ...
  return {
    start: parseInt(lineParts[0], 10),
    end: parseInt(lineParts[1], 10),
    modulus: lineParts[2],
    u: parseInt(lineParts[3], 10),
    v: parseInt(lineParts[4], 10),
    w: parseInt(lineParts[5], 10),
    x: parseInt(lineParts[6], 10),
    y: parseInt(lineParts[7], 10),
    z: parseInt(lineParts[8], 10),
    a: parseInt(lineParts[3], 10),
    b: parseInt(lineParts[4], 10),
    c: parseInt(lineParts[5], 10),
    d: parseInt(lineParts[6], 10),
    e: parseInt(lineParts[7], 10),
    f: parseInt(lineParts[8], 10),
    g: parseInt(lineParts[9], 10),
    h: parseInt(lineParts[10], 10),
    exception: lineParts[11] ? parseInt(lineParts[11], 10) : null,
  };
};

module.exports = valacdos_v350
  .split('\n')
  .map(formatLine);
